...
#             query_information[2] = self.bt_dict[query_information[1]]
#
...
#             result = self.query_routes_with_bus(query_information)
#
#
#
#     def query_routes_with_bus(self, query_information):
#
#
#         return None
#
...
PATH = "C:\\Users\\Aniruthan Ramadoss\\chromedriver.exe"
driver: selenium.webdriver.chrome.webdriver.WebDriver = webdriver.Chrome(PATH)
driver.get("https://ridebt.org/routes-schedules?route=MSS")
lst = []

table = driver.find_element_by_css_selector("#stopTable")
for row in table.find_elements_by_css_selector('tr'):
    # lst.append(row.find_elements_by_css_selector("stopTime"))
    print(row.find_elements_by_css_selector("stopTime"))
